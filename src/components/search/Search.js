...
const Search = () => {
	...
	const onChangeInput = (event) => {
		...
		updInptValue(event.target.value);
	}

	const updInptValue = useCallback(
		debounce((value) => {
		...
		<div className="advanced-menu__search">
			<form className="advanced-menu__form" >
				<input
					...
					className="advanced-menu__input"
				/>
				{value && (<button className="advanced-menu__btn" onClick={onClickClear}>						
