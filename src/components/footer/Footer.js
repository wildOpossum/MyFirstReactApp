							...
							<div className="social-footer__items">
								<a href="" className="social-footer__item">									
									<svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path fill-rule="evenodd" clip-rule="evenodd" d="M12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18ZM12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16Z" fill="url(#icon-grad)"/>
										...
										<defs>
											<linearGradient id="icon-grad" x1="15" y1="0" x2="0" y2="0" gradientUnits="userSpaceOnUse">
												...
												<stop offset="100%" stop-color="#ffa228"/>
											</linearGradient>
										</defs>
									</svg>
								</a>
